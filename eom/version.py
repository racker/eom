...
version_info = pbr.version.VersionInfo('eom')


def verify_sha(expected):
    """Verifies the commit hash for an interim build.

    This function may be used to verify that the version of the
    ...
    Note that this function will ALWAYS return False for packages that
    were not installed from git.
